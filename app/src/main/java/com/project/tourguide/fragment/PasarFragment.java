...
public class PasarFragment extends Fragment {
    private FragmentPasarBinding binding;
    ...
    private void initRecylerView() {
        binding.rvPasar.setLayoutManager(new LinearLayoutManager(getActivity()));
        adapter = new FragmentAdapter();
        binding.rvPasar.setAdapter(adapter);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPasarBinding.inflate(inflater, container, false);
